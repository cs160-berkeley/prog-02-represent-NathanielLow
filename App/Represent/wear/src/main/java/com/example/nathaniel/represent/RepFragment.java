...
//    private OnFragmentInteractionListener mListener;
    ...
    public static RepFragment newInstance(String param1, String param2, String param3, int param4) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView portrait = (ImageView) v.findViewById(R.id.fragment_portrait);
        ...
        portrait.setImageResource(mParam4);
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(mParam1.equals("2012 Presidential Vote"))) {
                    ...
                    toPhoneIntent.putExtra("REP_NAME", mParam2);
