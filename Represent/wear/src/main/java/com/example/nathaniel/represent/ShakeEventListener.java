 ...
 * Code taken from Ben Jakuben on StackOverflow (http://stackoverflow.com/questions/2317428/android-i-want-to-shake-it)
 */
import android.hardware.Sensor;
import android.hardware.SensorEvent;
import android.hardware.SensorEventListener;
...
public class ShakeEventListener implements SensorEventListener {
    ...
    private static final int MAX_PAUSE_BETHWEEN_DIRECTION_CHANGE = 7000;

    /** Maximum allowed time for shake gesture. */
    private static final int MAX_TOTAL_DURATION_OF_SHAKE = 14000;
